...
- [ ] Gate E: kill the watchdog service process while the GUI/controller owns 30/30; prove the live controller detects watchdog loss, restores locally, and SCM restarts the service cleanly.
