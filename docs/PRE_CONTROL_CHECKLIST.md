...
- [ ] Gate G1/G2: suspend/resume with the full watchdog stack, including normal pre-sleep lease release, stable watchdog PID, fresh post-boundary telemetry and 5/5 repeated cycles.
