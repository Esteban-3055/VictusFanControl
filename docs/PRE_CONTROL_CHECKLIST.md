...
- [ ] Implement and validate Gate C: named-pipe lease protocol, durable journal and synthetic crash/restart boundary tests before real-hardware lease integration.
