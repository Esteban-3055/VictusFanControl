...
Assert-Contains -Text $harness -Pattern 'journalProof=watchdog-release-response\\+post-resume-ready-check' -Description 'physical Gate G1 requires Release plus independent post-wake Ready/journal proof'
