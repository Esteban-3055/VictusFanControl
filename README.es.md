...
- watchdog Gate D implementado y cubierto por regresiones CI: servicio LocalSystem persistente, lease real alrededor de `SetFanLevel`, revalidación EC post-WriteIntent, Commit solo tras EC+tacómetros, heartbeat ligado a health/ownership y detección por handle de muerte de la GUI. Falta la prueba física Gate D.
